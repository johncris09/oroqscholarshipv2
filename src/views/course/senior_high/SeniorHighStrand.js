...
const SeniorHighStrand = () => {
  const _table = 'shs_course'
    ...
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Senior High School Strand</strong>
            <CButton color="primary" className="float-end" onClick={handleAdd}>
              <FontAwesomeIcon icon={faPlusCircle} /> Add New Strand
            </CButton>
          </CCardHeader>
          <CCardBody>
            <MaterialReactTable
      ...
      >
        <CModalHeader>
          <CModalTitle>{editMode ? 'Edit Strand' : 'Add New Strand'}</CModalTitle>
        </CModalHeader>
        <CModalBody>
          <p>
            Note:{' '}
          ...
          >
            <CCol md={12}>
              <CFormInput
                type="text"
                feedbackInvalid="Strand Name is required"
                id="strand-name"
                label={
                  <>
                    Strand Name
...
export default SeniorHighStrand
